...
/*  DESCRIPTION                                                           */
/*                                                                        */
/*    This function is called when the host requests a change of          */
...
/*                                          for selected alternate        */
/*                                          setting. Address of the device*/
/*                                          framework for this interface. */
/*    device_framework_length               Length of device framework    */
/*    alternate_setting_value               Alternate setting value to be */
		...
		switch (descriptor_type)
		{
			case UX_ENDPOINT_DESCRIPTOR_ITEM:
				...
				_ux_utility_descriptor_parse(device_framework,
						_ux_system_endpoint_descriptor_structure, UX_ENDPOINT_DESCRIPTOR_ENTRIES,
			...
			case UX_INTERFACE_DESCRIPTOR_ITEM:
				/* If the descriptor is a configuration or interface, we have parsed and mounted all
				 * endpoints. The interface attached to this configuration must be started at
				 * the class level. */
