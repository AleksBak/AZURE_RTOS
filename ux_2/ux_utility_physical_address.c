...
{
	/* Any code to translate the virtual address into a physical address will be below.
	 * If there is no translation, the physical address = the virtual address. */
	VOID* physical_address = virtual_address;
