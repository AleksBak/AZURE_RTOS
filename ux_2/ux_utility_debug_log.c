		...
		ULONG debug_parameter_1, ULONG debug_parameter_2)
{
	...
	total_debug_message_length = debug_location_string_length + debug_message_string_length + 10
			+ 10 + 10 + 10 + 5;
	...
	*_ux_system->ux_system_debug_log_head = ',';
	...
	_ux_utility_memory_copy(_ux_system->ux_system_debug_log_head, debug_location,
			debug_location_string_length);
	_ux_system->ux_system_debug_log_head += debug_location_string_length;
	*_ux_system->ux_system_debug_log_head = ',';
	_ux_system->ux_system_debug_log_head++;
	_ux_utility_memory_copy(_ux_system->ux_system_debug_log_head, debug_message,
			debug_message_string_length);
	...
	*_ux_system->ux_system_debug_log_head = 0x00;
	...
	/* The log string is put into the log buffer.  It can stay here until a break into debugger
	 * by the developer or be passed to a callback registered by the application. */
	if (_ux_system->ux_system_debug_callback_function != UX_NULL)
	{
		/* The callback function is defined, call it. */
		_ux_system->ux_system_debug_callback_function(_ux_system->ux_system_debug_log_tail,
				debug_code);
