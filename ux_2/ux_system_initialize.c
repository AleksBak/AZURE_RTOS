		...
		VOID* cache_safe_memory_pool_start, ULONG cache_safe_memory_size)
{
	...
	ULONG memory_pool_offset = sizeof(UX_SYSTEM);
	...
	_ux_system->ux_system_debug_log_buffer = _ux_utility_memory_allocate(UX_NO_ALIGN,
			UX_REGULAR_MEMORY, UX_DEBUG_LOG_SIZE);
