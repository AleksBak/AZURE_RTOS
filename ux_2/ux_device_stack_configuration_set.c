...
/*  DESCRIPTION                                                           */
/*                                                                        */
/*    This function is used by the host to set the current configuration  */
/*    running in the device. Upon reception of this command, the USB      */
/*    device stack will activate the alternate setting 0 of each          */
/*    interface connected to this configuration.                          */
/*                                                                        */
/*  INPUT                                                                 */
/*                                                                        */
...
UINT _ux_device_stack_configuration_set(ULONG configuration_value)
{
	...
	while (device_framework_length != 0)
	{
		...
		if (descriptor_type == UX_INTERFACE_DESCRIPTOR_ITEM)
		{
			/* Parse the descriptor in something more readable. */
			_ux_utility_descriptor_parse(device_framework,
					_ux_system_interface_descriptor_structure, UX_INTERFACE_DESCRIPTOR_ENTRIES,
