...
static WEATHER_INFO weather_info_list[] = {
    { &win_San_Diego.base, "San Diego", 75, 82, 70, 0, GX_PIXELMAP_ID_WEATHER_ICON_CLOUDY, "Partly Cloudy", 19, 58, San_Diego_weather_7day_info_list},
    { &win_New_York.base, "New York", 67, 71, 52, 90, GX_PIXELMAP_ID_WEATHER_ICON_RAIN, "Rain", 11, 64, New_York_weather_7day_info_list },
    { &win_Las_Vegas.base, "Las Vegas", 80, 85, 68, 0, GX_PIXELMAP_ID_WEATHER_ICON_SUN, "Sunny", 5, 14, Las_Vegas_weather_7day_info_list},
    { GX_NULL, "", 0, 0, 0, 0, 0, "", 0, 0, 0}
};
...
static VOID init_weather_info(WEATHER_INFO *info)
{
    ...
    /* Set city name. */
    gx_prompt_text_set(&base->weather_base_city_name, info->city_name);
    ...
    /* Set weather text. */
    gx_prompt_text_set(&base->weather_base_weather_text, info->weather_text);
...
static VOID start_weather_children_animation(WEATHER_INFO *info)
{
    ...
    animation_info.gx_animation_style = GX_ANIMATION_SINE_EASE_OUT;
...
VOID weather_screen_init()
{
    ...
    gx_prompt_text_set(&weather_screen.base.screen_base_add_text, "ADD CITY");
}