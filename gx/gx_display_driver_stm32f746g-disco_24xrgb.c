...
/**************************************************************************/
static void stm32f746_24xrgb_buffer_toggle(GX_CANVAS *canvas, GX_RECTANGLE *dirty)
{
GX_RECTANGLE    Limit;
GX_RECTANGLE    Copy;
ULONG           offset;
...
/*                                                                        */
/**************************************************************************/
UINT stm32f746_graphics_driver_setup_24xrgb(GX_DISPLAY *display)
{
    ...
    */
    _gx_display_driver_24xrgb_setup(display, (VOID*)STM32F746G_DISCO_SCREEN_HANDLE, stm32f746_24xrgb_buffer_toggle);
