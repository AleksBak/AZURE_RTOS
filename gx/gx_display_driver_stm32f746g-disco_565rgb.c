...
#include   "gx_display_driver_stm32f746g-disco_565rgb.h"
...
/*                                                                        */
/**************************************************************************/
UINT stm32f746_graphics_driver_setup_565rgb(GX_DISPLAY *display)
{
    ...
    */
    _gx_display_driver_565rgb_setup(display, (VOID*)STM32F746G_DISCO_SCREEN_HANDLE, stm32f746_565rgb_buffer_toggle);
