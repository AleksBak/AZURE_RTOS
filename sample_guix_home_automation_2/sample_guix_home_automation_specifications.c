...
/*  Date (dd.mm.yyyy):  7. 5.2020   Time (hh:mm): 15:06                        */
/*******************************************************************************/
...
GX_STUDIO_DISPLAY_INFO sample_guix_home_automation_display_table[1] =
		{
			{
				"display_1",
				"display_1_canvas",
...
static GX_WIDGET* gx_studio_action_target_find(GX_WIDGET* current,
...
static GX_WIDGET* gx_studio_action_parent_find(GX_WIDGET* current,
GX_CONST GX_STUDIO_ACTION* action)
{
	GX_WIDGET* parent = GX_NULL;
	GX_STUDIO_WIDGET* widget_define;
...
UINT gx_studio_auto_event_handler(GX_WIDGET* widget, GX_EVENT* event_ptr,
GX_CONST GX_STUDIO_EVENT_PROCESS* record)
{
...
UINT gx_studio_multi_line_text_button_create(GX_CONST GX_STUDIO_WIDGET* info,
		GX_WIDGET* control_block, GX_WIDGET* parent)
{
	...
	status = gx_multi_line_text_button_create(button, info->widget_name, parent, props->string_id,
...
#else
		gx_text_button_text_color_set((GX_TEXT_BUTTON*)button, props->normal_text_color_id,
				props->selected_text_color_id, props->disabled_text_color_id);
#endif
	}
	return status;
}

UINT gx_studio_radio_button_create(GX_CONST GX_STUDIO_WIDGET* info, GX_WIDGET* control_block,
		GX_WIDGET* parent)
{
	UINT status;
	...
	status = gx_radio_button_create(button, info->widget_name, parent, props->string_id,
			info->style, info->widget_id, &info->size);
	if (status == GX_SUCCESS)
	{
...
#else
		gx_text_button_text_color_set(text_button, props->normal_text_color_id,
				props->selected_text_color_id, props->disabled_text_color_id);
#endif
...
UINT gx_studio_pixelmap_button_create(GX_CONST GX_STUDIO_WIDGET* info, GX_WIDGET* control_block,
		GX_WIDGET* parent)
{
	UINT status;
...
UINT gx_studio_icon_create(GX_CONST GX_STUDIO_WIDGET* info, GX_WIDGET* control_block,
		GX_WIDGET* parent)
{
	UINT status;
	GX_ICON* icon = (GX_ICON*)control_block;
	GX_ICON_PROPERTIES* props = (GX_ICON_PROPERTIES*)info->properties;
	status = gx_icon_create(icon, info->widget_name, parent, props->normal_pixelmap_id, info->style,
			info->widget_id, info->size.gx_rectangle_left, info->size.gx_rectangle_top);
...
UINT gx_studio_radial_slider_create(GX_CONST GX_STUDIO_WIDGET* info, GX_WIDGET* control_block,
		GX_WIDGET* parent)
{
	UINT status;
	...
	status = gx_radial_slider_create(slider,
			...
			info->widget_id,
			&info->size);
	gx_radial_slider_animation_set(slider, props->animation_total_steps, props->animation_delay,
			props->animation_style, props->animation_update_callback);
	return status;
}

UINT gx_studio_prompt_create(GX_CONST GX_STUDIO_WIDGET* info, GX_WIDGET* control_block,
		GX_WIDGET* parent)
{
	UINT status;
	GX_PROMPT* prompt = (GX_PROMPT*)control_block;
	GX_PROMPT_PROPERTIES* props = (GX_PROMPT_PROPERTIES*)info->properties;
	status = gx_prompt_create(prompt, info->widget_name, parent, props->string_id, info->style,
...
UINT gx_studio_numeric_prompt_create(GX_CONST GX_STUDIO_WIDGET* info, GX_WIDGET* control_block,
		GX_WIDGET* parent)
{
	UINT status;
	...
	status = gx_numeric_prompt_create(prompt, info->widget_name, parent, props->string_id,
			info->style, info->widget_id, &info->size);
	if (status == GX_SUCCESS)
	{
...
#else
		gx_prompt_text_color_set((GX_PROMPT*)prompt, props->normal_text_color_id,
				props->selected_text_color_id, props->disabled_text_color_id);
#endif
		if (!props->string_id)
		{
...
UINT gx_studio_window_create(GX_CONST GX_STUDIO_WIDGET* info, GX_WIDGET* control_block,
		GX_WIDGET* parent)
{
	UINT status;
	GX_WINDOW* window = (GX_WINDOW*)control_block;
	GX_WINDOW_PROPERTIES* props = (GX_WINDOW_PROPERTIES*)info->properties;
	status = gx_window_create(window, info->widget_name, parent, info->style, info->widget_id,
			&info->size);
	if (status == GX_SUCCESS)
	{
...
UINT gx_studio_template_create(GX_CONST GX_STUDIO_WIDGET* info, GX_WIDGET* control_block,
		GX_WIDGET* parent)
{
	UINT status = GX_SUCCESS;
...
GX_ANIMATION_INFO passcode_screen_animation_5 = {
	...
	{ 297, -60 }, { 297, 53 }, 255, 255, 30
};

GX_STUDIO_ACTION passcode_screen_on_gx_event_showactions[6] = {
	{ GX_ACTION_TYPE_ANIMATION, 0, &passcode_screen, &passcode_screen.passcode_screen_num_pad,
		&passcode_screen_animation_1 },
	{ GX_ACTION_TYPE_ANIMATION, 0, &passcode_screen, &passcode_screen.passcode_screen_passcode_1,
		&passcode_screen_animation_2 },
	{ GX_ACTION_TYPE_ANIMATION, 0, &passcode_screen, &passcode_screen.passcode_screen_passcode_2,
		&passcode_screen_animation_3 },
	{ GX_ACTION_TYPE_ANIMATION, 0, &passcode_screen, &passcode_screen.passcode_screen_passcode_3,
		&passcode_screen_animation_4 },
	{ GX_ACTION_TYPE_ANIMATION, 0, &passcode_screen, &passcode_screen.passcode_screen_passcode_4,
		&passcode_screen_animation_5 },
...
GX_STUDIO_EVENT_PROCESS passcode_screen_event_chain = { gx_studio_passcode_screen_event_table,
	(UINT (*)(GX_WIDGET*, GX_EVENT*))passcode_screen_event_process };
...
GX_CONST GX_STUDIO_WIDGET screen_base_thermostat_define =
		{
			...
			0, /* user data                      */
#endif
			GX_STYLE_BORDER_NONE | GX_STYLE_TRANSPARENT | GX_STYLE_HALIGN_CENTER
...
GX_CONST GX_STUDIO_WIDGET screen_base_add_define =
		{
			...
			0, /* user data                      */
#endif
			GX_STYLE_BORDER_NONE | GX_STYLE_TRANSPARENT | GX_STYLE_ENABLED | GX_STYLE_HALIGN_RIGHT
					| GX_STYLE_VALIGN_TOP, /* style flags */
			GX_STATUS_ACCEPTS_FOCUS, /* status flags                   */
			sizeof(GX_PIXELMAP_BUTTON), /* control block size             */
			GX_COLOR_ID_BTN_LOWER, /* normal color id                */
...
GX_STUDIO_ACTION main_screen_on_user_event_fade_out_home_windowactions[2] = {
	{ GX_ACTION_TYPE_ANIMATION, 0, &main_screen, &main_screen.main_screen_home_window,
		&main_screen_animation_1 },
	{ 0, 0, GX_NULL, GX_NULL, GX_NULL }
};

GX_STUDIO_ACTION main_screen_on_user_event_fade_in_home_windowactions[2] = {
	{ GX_ACTION_TYPE_ANIMATION, 0, &main_screen, &main_screen.main_screen_home_window,
		&main_screen_animation_2 },
	{ 0, 0, GX_NULL, GX_NULL, GX_NULL }
};
...
GX_STUDIO_EVENT_PROCESS main_screen_event_chain = { gx_studio_main_screen_event_table, (UINT (*)(
		GX_WIDGET*, GX_EVENT*))main_screen_event_process };
...
GX_CONST GX_STUDIO_WIDGET thermostat_screen_pagination_4_define =
		{
			...
			0, /* user data                      */
#endif
			GX_STYLE_BORDER_NONE | GX_STYLE_TRANSPARENT | GX_STYLE_ENABLED | GX_STYLE_BUTTON_RADIO
...
GX_CONST GX_STUDIO_WIDGET thermostat_screen_pagination_1_define =
		{
			...
			0, /* user data                      */
#endif
			GX_STYLE_BORDER_NONE | GX_STYLE_TRANSPARENT | GX_STYLE_ENABLED | GX_STYLE_BUTTON_PUSHED
					| GX_STYLE_BUTTON_RADIO | GX_STYLE_TEXT_CENTER, /* style flags */
			GX_STATUS_ACCEPTS_FOCUS, /* status flags                   */
			sizeof(GX_RADIO_BUTTON), /* control block size             */
			GX_COLOR_ID_BTN_LOWER, /* normal color id                */
			GX_COLOR_ID_BTN_UPPER, /* selected color id              */
...
GX_STUDIO_EVENT_PROCESS thermostat_screen_event_chain = { gx_studio_thermostat_screen_event_table,
	(UINT (*)(GX_WIDGET*, GX_EVENT*))screen_base_event_process };
...
GX_STUDIO_EVENT_PROCESS lights_screen_event_chain = { gx_studio_lights_screen_event_table,
	(UINT (*)(GX_WIDGET*, GX_EVENT*))screen_base_event_process };
...
GX_CONST GX_STUDIO_WIDGET locks_door_base_status_icon_define =
		{
			...
			0, /* user data                      */
#endif
			GX_STYLE_BORDER_NONE | GX_STYLE_TRANSPARENT | GX_STYLE_ENABLED | GX_STYLE_HALIGN_LEFT
					| GX_STYLE_VALIGN_TOP, /* style flags */
			GX_STATUS_ACCEPTS_FOCUS, /* status flags                   */
			sizeof(GX_ICON), /* control block size             */
			GX_COLOR_ID_WIDGET_FILL, /* normal color id                */
...
GX_STUDIO_EVENT_PROCESS locks_screen_event_chain = { gx_studio_locks_screen_event_table, (UINT (*)(
		GX_WIDGET*, GX_EVENT*))screen_base_event_process };
...
GX_STUDIO_EVENT_PROCESS win_San_Diego_event_chain = { gx_studio_win_San_Diego_event_table,
	(UINT (*)(GX_WIDGET*, GX_EVENT*))gx_window_event_process };
...
GX_STUDIO_EVENT_PROCESS win_New_York_event_chain = { gx_studio_win_New_York_event_table, (UINT (*)(
		GX_WIDGET*, GX_EVENT*))gx_window_event_process };
...
GX_STUDIO_EVENT_PROCESS win_Las_Vegas_event_chain = { gx_studio_win_Las_Vegas_event_table,
	(UINT (*)(GX_WIDGET*, GX_EVENT*))gx_window_event_process };
...
GX_STUDIO_EVENT_PROCESS weather_screen_event_chain = { gx_studio_weather_screen_event_table,
	(UINT (*)(GX_WIDGET*, GX_EVENT*))screen_base_event_process };
...
GX_STUDIO_EVENT_PROCESS thermostat_page_4_event_chain = { gx_studio_thermostat_page_4_event_table,
	(UINT (*)(GX_WIDGET*, GX_EVENT*))gx_window_event_process };
...
GX_STUDIO_EVENT_PROCESS thermostat_page_3_event_chain = { gx_studio_thermostat_page_3_event_table,
	(UINT (*)(GX_WIDGET*, GX_EVENT*))gx_window_event_process };
...
GX_STUDIO_EVENT_PROCESS thermostat_page_2_event_chain = { gx_studio_thermostat_page_2_event_table,
	(UINT (*)(GX_WIDGET*, GX_EVENT*))gx_window_event_process };
...
GX_STUDIO_EVENT_PROCESS thermostat_page_1_event_chain = { gx_studio_thermostat_page_1_event_table,
	(UINT (*)(GX_WIDGET*, GX_EVENT*))gx_window_event_process };
...
GX_STUDIO_EVENT_PROCESS lights_page_3_event_chain = { gx_studio_lights_page_3_event_table,
	(UINT (*)(GX_WIDGET*, GX_EVENT*))gx_window_event_process };
...
GX_STUDIO_EVENT_PROCESS lights_page_2_event_chain = { gx_studio_lights_page_2_event_table,
	(UINT (*)(GX_WIDGET*, GX_EVENT*))gx_window_event_process };
...
GX_STUDIO_EVENT_PROCESS lights_page_4_event_chain = { gx_studio_lights_page_4_event_table,
	(UINT (*)(GX_WIDGET*, GX_EVENT*))gx_window_event_process };
...
GX_STUDIO_EVENT_PROCESS lights_page_1_event_chain = { gx_studio_lights_page_1_event_table,
	(UINT (*)(GX_WIDGET*, GX_EVENT*))gx_window_event_process };
...
GX_STUDIO_EVENT_PROCESS locks_page_3_event_chain = { gx_studio_locks_page_3_event_table, (UINT (*)(
		GX_WIDGET*, GX_EVENT*))gx_window_event_process };
...
GX_STUDIO_EVENT_PROCESS locks_page_2_event_chain = { gx_studio_locks_page_2_event_table, (UINT (*)(
		GX_WIDGET*, GX_EVENT*))gx_window_event_process };
...
GX_STUDIO_EVENT_PROCESS locks_page_1_event_chain = { gx_studio_locks_page_1_event_table, (UINT (*)(
		GX_WIDGET*, GX_EVENT*))locks_page_1_event_process };
...
GX_CONST GX_STUDIO_WIDGET_ENTRY sample_guix_home_automation_widget_table[] =
		{
...
#else
					gx_widget_fill_color_set(widget, definition->normal_fill_color_id,
							definition->selected_fill_color_id, definition->disabled_fill_color_id);
#endif
				}
...
GX_WIDGET* gx_studio_widget_create(GX_BYTE* control, GX_CONST GX_STUDIO_WIDGET* definition,
		GX_WIDGET* parent)
{
	GX_WIDGET* widget;
...
UINT gx_studio_named_widget_create(char* name, GX_WIDGET* parent, GX_WIDGET** new_widget)
{
	...
	GX_CONST GX_STUDIO_WIDGET_ENTRY* entry = sample_guix_home_automation_widget_table;
	GX_WIDGET* widget = GX_NULL;
	...
	while (entry->widget_information)
	{
		...
		{
			widget = gx_studio_widget_create((GX_BYTE*)entry->widget, entry->widget_information,
					parent);
			if (widget)
			{
				status = GX_SUCCESS;
...
UINT gx_studio_display_configure(USHORT display, UINT (*driver)(GX_DISPLAY*), GX_UBYTE language,
		USHORT theme, GX_WINDOW_ROOT** return_root)
{
	GX_CONST GX_THEME* theme_ptr;
	GX_RECTANGLE size;

	GX_STUDIO_DISPLAY_INFO* display_info = &sample_guix_home_automation_display_table[display];
